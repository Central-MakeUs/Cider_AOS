...
import com.cider.cider.databinding.ItemChallengeCard2Binding
...
class ChallengeCard2Adapter(private val viewModel : ChallengeListViewModel): ListAdapter<ChallengeCardModel, RecyclerView.ViewHolder>(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return ChallengeCardVieHolder(ItemChallengeCard2Binding.inflate(inflater, parent, false))
    }
    ...
    inner class ChallengeCardVieHolder(
        private val binding: ItemChallengeCard2Binding
